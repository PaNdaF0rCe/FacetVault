...
function InventoryItemCard({ item, onClick }) {
  ...
  return (
    <button
      ...
      className="group flex w-full items-center gap-3 rounded-[22px] border border-white/10 bg-[#020617]/95 p-3 text-left shadow-[0_8px_24px_rgba(0,0,0,0.16)] transition duration-200 hover:-translate-y-0.5 hover:border-amber-400/50 hover:shadow-[0_14px_34px_rgba(0,0,0,0.24)]"
    >
